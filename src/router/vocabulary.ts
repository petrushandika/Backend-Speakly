...
const STUDY_WORDS: StudyWord[] = [
  ...
  { word: "presume",     phonetic: "/prɪˈzjuːm/",          definition: "To suppose something is true without direct proof",   indonesian: "menduga / mengira",         example: "Don't presume the meeting is cancelled without checking.", category: "work",            cefrLevel: "B2" },
